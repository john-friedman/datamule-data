...
def construct_sec_phrases_2(text_queries, file_path, start_date=None, submission_type=None, document_type=None):
    """
    ...
    for text_query in text_queries:
        ...
        for result in results:
            ...
            if document_type is not None and result['_source'].get('form') != document_type:
                continue
